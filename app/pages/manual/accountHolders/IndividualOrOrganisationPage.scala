...
final case class IndividualOrOrganisationPage()(implicit reportId: ReportId) extends QuestionPage[IndividualOrOrganisation]:

  override def path: JsPath = JsPath \ toString

  override def toString: String = "individualOrOrganisation"
