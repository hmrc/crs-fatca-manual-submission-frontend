...
//
//object AccountPaymentsSummary  {
//
//  def row(answers: UserAnswers)(implicit messages: Messages, reportId: ReportId): Option[SummaryListRow] =
//    answers.get(DoYouNeedToAddPaymentsPage()).map {
//      answer =>
//
//        val value = if (answer) "site.yes" else "site.no"
//
//        SummaryListRowViewModel(
//          key     = "accountPayments.checkYourAnswersLabel",
//          value   = ValueViewModel(value),
//          actions = Seq(
//            ActionItemViewModel("site.change", routes.AccountPaymentsController.onPageLoad(CheckMode).url)
//              .withVisuallyHiddenText(messages("accountPayments.change.hidden"))
//          )
//        )
//    }
//}
