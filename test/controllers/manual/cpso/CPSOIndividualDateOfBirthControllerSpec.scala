...
import pages.manual.cpso.{CPSOIndividualDateOfBirthPage, CurrentCPSOIdPage, IndividualNamePage}
...
class CPSOIndividualDateOfBirthControllerSpec extends SpecBase with MockitoSugar {
  ...
  "CPSOIndividualDateOfBirth Controller" - {
    ...
    val ua =
      emptyUserAnswers
        ...
        .withPage(
          CurrentCPSOIdPage()(reportId),
          cpsoId
        )
        .withPage(
          IndividualNamePage(cpsoId)(reportId),
          individualName
        )
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request =
          FakeRequest(GET, CPSOIndividualDateOfBirthRoute)

        val view =
          application.injector
            .instanceOf[CPSOIndividualDateOfBirthView]
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, CPSOIndividualDateOfBirthRoute)
