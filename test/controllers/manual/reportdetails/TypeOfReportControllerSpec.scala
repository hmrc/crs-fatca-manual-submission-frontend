...
import controllers.manual.reportdetails.routes.TypeOfReportController
...
class TypeOfReportControllerSpec extends SpecBase {
  ...
  val fiName                         = "name"
  val fiId                           = "TestfiID"
  private lazy val typeOfReportRoute = TypeOfReportController.onPageLoad(NormalMode).url
