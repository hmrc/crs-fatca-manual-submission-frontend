...
class AccountHolderAddressNonUkControllerSpec extends SpecBase with MockitoSugar {

  private val onwardRoute = Call("GET", "/foo")

  private val formProvider = new AccountHolderAddressNonUkFormProvider()
  ...
  private lazy val addressNonUkRoute =
    controllers.manual.accountHolders.routes.AccountHolderAddressNonUkController.onPageLoad(NormalMode).url

  private val individualAccountHolder          = IndividualName("Some", "Dude")
  private val accountHolderId: AccountHolderId = AccountHolderId("TestAccountHolderId")
