...
class IsThisTheAddressForAccountHoldersControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val isThisTheAddressForAccountHoldersRoute = controllers.manual.accountHolders.routes.IsThisTheAddressForAccountHoldersController.onPageLoad(NormalMode).url
  ...
  "IsThisTheAddressForAccountHolders Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = ua.set(IsThisTheAddressForAccountHoldersPage(), true).success.value
