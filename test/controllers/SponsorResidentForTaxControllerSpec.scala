...
class SponsorResidentForTaxControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val sponsorResidentForTaxRoute = routes.SponsorResidentForTaxController.onPageLoad(NormalMode).url
  ...
  "SponsorResidentForTax Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = ua.set(SponsorResidentForTaxPage(), "answer").success.value
