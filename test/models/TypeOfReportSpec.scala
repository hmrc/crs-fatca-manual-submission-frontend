...
class TypeOfReportSpec extends AnyFreeSpec with Matchers with ScalaCheckPropertyChecks with OptionValues {
  ...
  "TypeOfReport" - {
    ...
    "must fail to deserialise invalid values" in {
      ...
      val gen = arbitrary[String] suchThat (!TypeOfReport.values.map(_.toString).contains(_))
